...
export default function GoalsStep() {
  ...
  async function finish() {
    ...
    const { lifeStage, pregnancyMode, weightTracking, conceiveMode } = resolveFromGoal(state.user.dob, selected);
    ...
    dispatch({ type: 'SET_SETTINGS', payload: { pregnancyMode, weightTracking, conceiveMode } });
